...
function obtenerPermissions(usuario) {
    ...
    modules.forEach(module => {
        ...
        if (
            ...
            !['admin', 'supervisor', 'superadmin'].includes(String(usuario.rol || '').toLowerCase())
        ) {
...
function verificarAccesoPagina(permisos) {
    ...
    const routePermissions = {
        ...
        '/views/close-center': 'closeCenter',
        '/views/exception-center': 'exceptionCenter',
        '/views/report-center': 'reportCenter',
        '/views/audit-center': 'auditCenter',
        '/views/integration-center': 'integrationCenter',
        '/views/governance-center': 'governanceSettings',
