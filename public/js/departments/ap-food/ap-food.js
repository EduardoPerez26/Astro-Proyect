(function () {
    ...
    console.info('[XBFS AP] ap.js loaded: 2026-07-09-prior-year-forward-quarter-review-v13');
    ...
    async function fetchPropertyDocumentBlob(id) {
        ...
        const filename = decodeDispositionFilename(disposition) || `ap-document-${id}`;
    ...
    async function apiFetch(path, options = {}) {
        ...
        return fetch(`${apiBase}${AP_API}${path}`, {
            ...options,
            headers: {
                ...(options.headers || {}),
