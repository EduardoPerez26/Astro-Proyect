-- ============================================
-- CORRECCIÓN DEL ESQUEMA DE PERMISOS
-- ============================================
-- Este script agrega las columnas faltantes a la tabla permisos
-- y crea las tablas necesarias para el sistema de permisos.
-- ============================================
