...
function getSystemInstruction() {
    return [
        ...
        'You also have tools to take real actions: list, create, and run scheduled reports in the Report Center; count pending documents; list departments; and create a new user account. ' +
